      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {user ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <Link to="/generate" className="group">
              <Card className="hover:shadow-2xl transition-all duration-500 cursor-pointer bg-white border-green-200 transform group-hover:scale-105 group-hover:-translate-y-2">
            ...
            <Link to="/saved" className="group">
              <Card className="hover:shadow-2xl transition-all duration-500 cursor-pointer bg-white border-orange-200 transform group-hover:scale-105 group-hover:-translate-y-2">
                <CardHeader className="text-center">
          ...
          <div className="text-center mb-12">
            <div className="bg-white rounded-lg shadow-xl p-8 max-w-2xl mx-auto mb-8 transform hover:scale-105 transition-all duration-500">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <Card className="bg-white shadow-xl transform hover:scale-105 transition-all duration-500 hover:shadow-2xl">
              <CardHeader>
        ...
        {/* Features Section */}
        <div className="mt-16 bg-white rounded-lg shadow-xl p-8 transform hover:scale-102 transition-all duration-500">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-8 transform hover:scale-105 transition-transform duration-300">
